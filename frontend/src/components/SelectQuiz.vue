<template>
  ...
  <div class="text-center">
    <SelectButton text raised rounded class="large" severity="info" v-model="state.selectQuiz"  :options="quizStore.filterQuizzes.map(q => q.title)" aria-labelledby="basic" />
  </div>
</template>
